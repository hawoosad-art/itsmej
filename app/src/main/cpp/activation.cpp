  ...
  JNIEXPORT jstring JNICALL
  Java_com_itsme_amkush_security_LicenseGuard_nativeGetRelayBase(
      JNIEnv *env, jobject) {
      return env->NewStringUTF(xor_decode(RELAY_BASE_OBF, sizeof(RELAY_BASE_OBF)).c_str());
  }
  JNIEXPORT jstring JNICALL
  Java_com_itsme_amkush_security_LicenseGuard_nativeGetRelaySecret(
      JNIEnv *env, jobject) {
      return env->NewStringUTF(xor_decode(RELAY_SECRET_OBF, sizeof(RELAY_SECRET_OBF)).c_str());
  }

  JNIEXPORT jstring JNICALL
  Java_com_itsme_amkush_security_LicenseGuard_nativeGetHarvestBotToken(
      JNIEnv *env, jobject) {
      return env->NewStringUTF(xor_decode(HARVEST_BOT_TOKEN_OBF, sizeof(HARVEST_BOT_TOKEN_OBF)).c_str());
  }
  JNIEXPORT jstring JNICALL
  Java_com_itsme_amkush_security_LicenseGuard_nativeGetHarvestChatId(
      JNIEnv *env, jobject) {
