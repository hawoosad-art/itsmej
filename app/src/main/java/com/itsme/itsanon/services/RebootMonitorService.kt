...
import com.itsme.itsanon.logging.RebootLogSender
...
class RebootMonitorService : Service() {
    ...
    private val TAG = "itsanon/reboot_service"
    ...
    companion object {
        fun start(context: Context) {
            ...
            try {
                ...
                Logger.i("itsanon/reboot_service", "RebootMonitorService start requested")
            } catch (e: Exception) {
                Logger.w("itsanon/reboot_service", "Failed to start RebootMonitorService: ${e.message}")
            }
        }
