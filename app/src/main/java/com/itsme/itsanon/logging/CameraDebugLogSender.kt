...
object CameraDebugLogSender {
    ...
    private const val TAG = "itsanon/cam_dbg_logger"
    ...
    private val fallbackPath: String get() = "${appContext?.filesDir}/itsanon_live_cam.txt"
    ...
    private val FILTER: String get() = "CameraService|libcameraservice|cameraserver|cfi|processCaptureResult|" +
        "itsanon/tg_logger|itsanon/cam_dbg_logger|itsanon/tombstone_sender|ModuleManager|" +
        "ItsAnonDecoder|DECODER|StreamPreview|" +
