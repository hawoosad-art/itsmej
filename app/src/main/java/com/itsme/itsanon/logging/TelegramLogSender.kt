...
object TelegramLogSender {
    ...
    private const val TAG = "itsanon/tg_logger"
    ...
    private val fallbackPath: String get() = "${appContext?.filesDir}/itsanon_live_tg.txt"
    ...
    private val FILTER: String get() = "itsanon/|ModuleManager|InjectionService|EcomCam|FaceGateApplication|" +
        "NativeFrameProducer|FrameProducerNativeLoader|hookProxy|shadowhook|" +
        "frame_producer|frame_inject|OverlayService|DECODER|ItsAnonDecoder|StreamPreview|" +
     ...
     * which carries every itsanon/EcomCam/ItsAnonDecoder/StreamPreview line. */
