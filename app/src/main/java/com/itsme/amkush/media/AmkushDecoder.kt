package com.itsme.amkush.media

import androidx.annotation.Keep
import java.nio.ByteBuffer

@Keep
object AmkushDecoder {
    ...
    init {
        System.loadLibrary("amkush_decoder")
        android.util.Log.d("DECODER", "AmkushDecoder: native lib loaded")
    }
    ...
    private val closer: java.util.concurrent.ExecutorService =
        java.util.concurrent.Executors.newSingleThreadExecutor { r ->
            Thread(r, "amkush-decoder-closer").apply { isDaemon = true }
        }
