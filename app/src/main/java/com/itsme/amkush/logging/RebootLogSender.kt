...
object RebootLogSender {
    ...
    private const val TAG = "amkush/reboot_logger"
    ...
    fun collectRebootLogs(): String {
        ...
        sb.appendLine(runRootCmd("cat /sys/fs/pstore/pmsg-ramoops* 2>&1 | grep -i -E 'amkush|cameraserver|fatal|crash|reboot|panic|watchdog' | tail -n 1000"))
        sb.appendLine()
        ...
        sb.appendLine()
        sb.appendLine("========== 7. logcat -b system -d | amkush/cameraserver ==========")
        sb.appendLine(runRootCmd("logcat -b system -d -v threadtime 2>&1 | grep -i -E 'amkush|cameraserver|reboot|panic|watchdog|fatal|crash' | tail -n 1000"))
        sb.appendLine()
        ...
        sb.appendLine(runRootCmd("echo ---- sender boot diag ----; cat /data/data/com.itsme.amkush/files/sender_boot_diag.txt 2>&1 | tail -n 150; echo ---- fallback live log: tg ----; cat /data/data/com.itsme.amkush/files/amkush_live_tg.txt 2>&1 | tail -n 250; echo ---- fallback live log: cam ----; cat /data/data/com.itsme.amkush/files/amkush_live_cam.txt 2>&1 | tail -n 250"))
        sb.appendLine()
